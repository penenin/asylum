//==============================================================================
//
//       Class Name:  	AsylumSettings_Tabs
//      Description:	
//           
//	Copyright (C) 2004 Team Asylum	
//
//==============================================================================
// Modified version of GUI2K4.Settings_Tabs
//==============================================================================
class AsylumSettings_Tabs extends UT2K4TabPanel;

//var automated GUIImage iBackground;

var GUIFooter           t_Footer;
var AsylumSettingsPage   Setting;
...
{
    if ( AsylumSettingsPage(MyOwner.MenuOwner) != None )
    {
        Setting = AsylumSettingsPage(MyOwner.MenuOwner);
...
{
    if ( (Setting == None || t_Footer == None) && AsylumSettingsPage(Sender) != None )
    {
        Setting = AsylumSettingsPage(Sender);
        bAlwaysApply = bAlwaysApply && Setting.bApplyImmediately;
        t_Footer = Setting.t_Footer;
    }
