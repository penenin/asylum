//==============================================================================
//
//       Class Name:	AsylumGUIController
//      Description:
//
...
class AsylumGUIController extends GUIController;
...
static simulated function string GetNewGamePage()
{
	Validate();
	return default.MainMenuOptions[0];
}

static simulated function string GetResumeGamePage()
{
	Validate();
...
static simulated function string GetCreditsPage()
{
	Validate();
...
defaultproperties
{
     ...
     //Begin Object Class=fntUT2k4AsylumMainMenu Name=GUIAsylumLargeFont
     //bFixedSize=false
     //End Object
     //FontStack(11)=GUIAsylumLargeFont
     ...
     DefaultStyleNames(5)="AsylumGame.STY2AsylumTextButton"
     ...
     DefaultStyleNames(45)="AsylumGame.STY2AsylumTextButtonEffect"
     ...
     MouseOverSound=2K4MenuSounds.Generic.msfxMouseOver
     ClickSound=2K4MenuSounds.Generic.msfxMouseClick
     EditSound=2K4MenuSounds.Generic.msfxEdit
     UpSound=2K4MenuSounds.Generic.msfxUp
     DownSound=2K4MenuSounds.Generic.msfxDown
     DragSound=2K4MenuSounds.Generic.msfxDrag
     FadeSound=2K4MenuSounds.Generic.msfxFade
	 MainMenuOptions(0)="AsylumGame.AsylumNewGamePage"
     MainMenuOptions(1)="GUI2K4.UT2K4ServerBrowser"
     MainMenuOptions(2)="AsylumGame.AsylumSettingsPage"
